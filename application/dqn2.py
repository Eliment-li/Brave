...
if __name__ == "__main__":
    ...
    parser.add_argument('--gym-id', type=str, default="MountainCar-v0",
    ...
    parser.add_argument('--swanlab-project', type=str, default="cleanRL",
...
env = ProcessObsInputEnv(gym.make(args.gym_id, render_mode="rgb_array"))
...
env =  RecordVideo(env, Path(get_root_path()) / "results" / "videos")
